...
install -m 0644 "$repo_root/assets/icons/${desktop_id}.png" \
    "$deb_root/usr/share/icons/hicolor/1024x1024/apps/${desktop_id}.png"
...
desktop-file-validate "$deb_root/usr/share/applications/${desktop_id}.desktop"
